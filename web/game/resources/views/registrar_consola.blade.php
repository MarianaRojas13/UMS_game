      ...
      <div class="col-12 col-md-8 col-lg-5 mx-auto" >
          <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="mb-3">
                      <label for="anio-txt">Año de Lansamiento</label>
                      <input type="number" class="form-control" id="anion-txt">
                  </div>
              </div>
    ...
    <header class="container-fluid" > <!--Esto del primary son colores ya definidos ejemplo bg-warning es amarillo->
        <nav class="navbar navbar-expand-lg navbar-light bg-warning">
            <div class="container-fluid">
              <a class="navbar-brand" href="#"><img src="{{asset('img/Dragon_Ball_Z.png')}}" class="img-fluid" class="logo"></a>
